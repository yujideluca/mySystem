...
void die(const char *s){
    ...
    //perror looks to the global errno variable and prints an error message
...
char *editorPrompt(char *prompt, void (*callback)(char *, int)) {
    ...
    while (1) {
        ...
        //if Esc (\x1b) is pressed 
            ...
            editorSetStatusMessage("");            /*the three if (callbackbuf, c) allow the caller to pass NULL 
